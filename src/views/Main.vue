...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    data() {
      return {
        query: 'MATCH (p1:Author)-[r:Article]-(p2:Author) where id(p1) = 18 and id(p2)=17 return p1,p2,r',
        // query: 'MATCH (u:Author) where id(u) = 15 CALL top.chendaye666.equitruss.search(u,4,4,1) YIELD id,authorId,name,count,community,words,raw RETURN id,authorId,name,count,community,words,raw',
        records: [],
        clearAll: false
      }
    },
